...
<template>
  <ul
    class="list-none flex flex-wrap flex-row justify-between sm:justify-around gap-y-6 py-4 bg-light-1 rounded-lg w-full shadow-lg"
  >
